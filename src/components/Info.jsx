function Info(){
    ...
    return (
        <>
          ...
          <img src="./src/assets/icons/batata.svg" alt="batata" className="w-[50px] place-self-center mb-9 -translate-y-4 "></img>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-7 p-10 mt-10 w-[100%] ">
            <div className=" bg-black-batata rounded-sm mx-auto text-stone-50 w-[100%]">
                    <img src="./src/assets/icons/clock.svg" alt="clock" className="mt-4 ml-5 "></img>
            ...
            <div className=" bg-black-batata rounded-sm mx-auto text-stone-50 w-[100%]">
              <img src="./src/assets/icons/eye.svg" alt="eye" className="mt-4 ml-5"></img>
            ...
            <div className=" bg-black-batata rounded-sm mx-auto text-stone-50 w-[100%]">
                    <img src="./src/assets/icons/dollar-sign.svg" alt="dollar" className="mt-4 ml-5"></img>
                    <p className="ml-5 mt-4 font-bold text-xl">Compara monedas</p>
                    <p className="ml-5 mt-4 font-bold text-md mb-6">No más rumores, con Babtabit sabrás el valor real de cada moneda en el mercado actual.</p>
            </div>
            <div className=" bg-black-batata rounded-sm mx-auto text-gray-100 w-[100%]">
                    <img src="./src/assets/icons/check-circle.svg" alt="check" className="mt-4 ml-5"></img>
          ...
          <section className="h-[60vh] bg-cover bg-center" style={{ backgroundImage: `url('./src/assets/imgs/bitcoinbaby2.png')` }}>
